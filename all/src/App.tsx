...
function App() {
  ...
  return (
    ...
    <hr style={{ gridColumn: '1 / -1', width: '100%', border: '0', borderTop: '1px solid #ccc', margin: '10px 0' }} />
        ...
        <span>Div-PreEntContex</span><span>EntEscrituras</span><span>My Info</span><span>Ellos-Info</span>
        <span>Sim-ProPruebaRap</span><span>Ayudar</span><span>Practicar</span><span>Ellos-Lugares</span>
        <span>Sim-PostRutAutoHabitos</span><span>AyudarRutAuto</span><span>RutAuto</span><span>Ellos-RutAuto</span>

    <hr style={{ gridColumn: '1 / -1', width: '100%', border: '0', borderTop: '1px solid #ccc', margin: '10px 0' }} />
    <hr style={{ gridColumn: '1 / -1', width: '100%', border: '0', borderTop: '1px solid #ccc', margin: '10px 0' }} />
        <span>Div-Lider Porque? AmistadAmor Video</span><span>Motivar Cristo</span><span>QQ</span><span>Ellos-Espiritu</span>
        <span>Div-PreEntContex</span><span>EntEscrituras</span><span>My Info</span><span>Ellos-Info</span>
        <span>Sim-ProPruebaRap</span><span>Noches Hogar (Actividades) </span><span>Practicar</span><span>Ellos-Lugares</span>
        <span>Sim-PostRutAutoHabitos</span><span>AyudarRutAuto</span><span>RutAuto</span><span>Ellos-RutAuto</span>        
    
    <hr style={{ gridColumn: '1 / -1', width: '100%', border: '0', borderTop: '1px solid #ccc', margin: '10px 0' }} />
        <span>Div-RInvAde Porque? Libertad Video</span><span>Motivar Bueno</span><span>QQ</span><span>Ellos-3Productos</span>
        <span>Div-PreEntContex-IA (Master)</span><span>PlanInnovLog</span><span>My Info</span><span>Ellos-Servicios</span>
        <span>Sim-ProPruebaRap</span><span>Demo</span><span>Probar</span><span>Ellos-Reparaciones</span>
        <span>Sim-PostRutAutoRobots</span><span>Suministro</span><span>RutAuto</span><span>Ellos-Empleo</span>
        
    <hr style={{ gridColumn: '1 / -1', width: '100%', border: '0', borderTop: '1px solid #ccc', margin: '10px 0' }} />
    <hr style={{ gridColumn: '1 / -1', width: '100%', border: '0', borderTop: '1px solid #ccc', margin: '10px 0' }} />
        <span>Div-REsp Porque? Gratitud Video</span><span>Motivar Bueno</span><span>QQ</span><span>Ellos-3Productos</span>
        <span>Div-PreEntContex-IA (Espe)</span><span>PlanInnovLog</span><span>My Info</span><span>Ellos-Servicios</span>
        <span>Sim-ProPruebaRap</span><span>Demo</span><span>Probar</span><span>Ellos-Reparaciones</span>
        <span>Sim-PostRutAutoRobots</span><span>Suministro</span><span>RutAuto</span><span>Ellos-Empleo</span>        
    
    <hr style={{ gridColumn: '1 / -1', width: '100%', border: '0', borderTop: '1px solid #ccc', margin: '10px 0' }} />
        <span>Div-RMund Porque? Entreten Video</span><span>Motivar Bueno</span><span>QQ</span><span>Ellos-3Productos</span>
        <span>Div-PreEntContex-IA</span><span>PlanInnovLog</span><span>My Info</span><span>Ellos-Servicios</span>
        <span>Sim-ProPruebaRap</span><span>Demo</span><span>Probar</span><span>Ellos-Reparaciones</span>
        <span>Sim-PostRutAutoRobots</span><span>Suministro</span><span>RutAuto</span><span>Ellos-Empleo</span>
